 ...
 * AuthManager
 * 
 * Microsoft authentication results are stored through ConfigManager.
 * 
 * @module authmanager
 */
// Requirements
...
/**
 * Add a Microsoft account using the provided authorization code.
...
exports.validateSelected = async function(){
    const current = ConfigManager.getSelectedAccount()
    return current?.type === 'microsoft' && await validateSelectedMicrosoftAccount()
}
